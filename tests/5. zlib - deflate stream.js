...
const compress = new zlib.Deflate(Object.assign(args, { flush: zlib.constants.Z_SYNC_FLUSH }));
const decompress = new zlib.Inflate(Object.assign(args, { flush: zlib.constants.Z_SYNC_FLUSH }));
